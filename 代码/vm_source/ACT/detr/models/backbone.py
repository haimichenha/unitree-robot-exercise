...
sys.path.append(HOME_PATH+"/ACT/detr")
print(HOME_PATH)
...
def build_backbone(args):
    position_embedding = build_position_encoding(args)  #选择了正弦位置编码
    ...
    model = Joiner(backbone, position_embedding) # Joiner 是一个容器，用于按顺序添加子模块（如神经网络层），并按顺序执行这些子模块
