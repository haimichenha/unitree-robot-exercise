...
def load_data(dataset_dir, camera_names, batch_size_train, batch_size_val, policy_class, num_workers=0):
    ...
    loader_kwargs = {'pin_memory': torch.cuda.is_available(), 'num_workers': num_workers}
    if num_workers > 0:
        loader_kwargs['prefetch_factor'] = 2
    train_dataloader = DataLoader(train_dataset, batch_sampler=batch_sampler_train, **loader_kwargs)
    val_dataloader = DataLoader(val_dataset, batch_sampler=batch_sampler_val, **loader_kwargs)
